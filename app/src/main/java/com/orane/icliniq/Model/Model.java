...
public class Model {
    ...
    public static String clinics, terms_isagree, device_token, vendor_name, agency_name, agency_val, doc_lang, treatment_skills, edit_query, doc_photo, doc_name, doc_sp, appt_id, meeting_id, docurl, screen_status, fcode, ftrack_show, cons_phno, sel_spec_code, query, speciality, photo_url, from, return_qid, local_file_url, mcode, mnum, str_status, first_query, mobvalidate, ftrack_fee, login_status, kmid, isValid, password, name, id, status, browser_country, email, fee_q, fee_consult, fee_q_inr, fee_consult_inr, currency_symbol, currency_label, have_free_credit;
    ...
    public static String chat_show_1sttime;
